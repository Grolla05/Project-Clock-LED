...
* Utilizar multiplexadores e lógica combinacional para controle e distribuição adequada das fontes do circuito.
...
![Diagrama do projeto pelo proteus](https://i.imgur.com/seu_diagrama_aqui.png)
*Figura 1 - diagrama do projeto pelo proteus*
...
**4.1 Transformador e Fonte Retificadora**
...
![Circuito da fonte retificadora no simulador, Proteus 9](https://i.imgur.com/seu_circuito_fonte.png)
*Figura 2 - Circuito da fonte retificadora no simulador, Proteus 9*
...
![Simulação dos registradores e contadores com display de 7 seg](https://i.imgur.com/seus_registradores.png)
*Figura 5 - simulação dos registradores e contadores com display de 7 seg*
...
![Montagem prática do circuito, fonte retificadora](https://i.imgur.com/sua_fonte_montada.png)
*Figura 6 - Montagem prática do circuito, fonte retificadora*
...
*Figura 11 — Circuito de separação de unidades*

**6.3 Indicador de nível de bateria**
...
*Figura 11 — Circuito simulado, indicador de nível de bateria*
